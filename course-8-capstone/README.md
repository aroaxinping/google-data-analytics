...
**Duracion:** 11 horas | **Modulos:** 4 | **Fase del proceso:** Capstone

El proyecto final del certificado. No hay nuevo contenido tecnico: es aplicar todo lo aprendido en los cursos 1-7 a un caso de negocio real. El output es un case study listo para incluir en el portfolio y presentar en entrevistas.

## Contenido del curso

- Modulo 1: Learn About Capstone Basics — que es un case study, que hace uno bueno y como usarlo en el portfolio
- Modulo 2: Build Your Portfolio — los dos tracks (Cyclistic o Bellabeat) y la opcion de caso propio; proceso completo Ask-Prepare-Process-Analyze-Share-Act
