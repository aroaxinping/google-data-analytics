...
- Modulo 1: Data Types and Structures — datos estructurados vs no estructurados, tipos de dato, formatos y la diferencia entre datos largos y amplios
- Modulo 2: Data Responsibility — sesgo, credibilidad con ROCCC, etica de datos y datos abiertos
- Modulo 3: Database Essentials — bases de datos relacionales, metadatos, SQL con BigQuery y ordenacion y filtrado
- Modulo 4: Organize and Protect Data — convencion de nombres, niveles de acceso y seguridad de datos

## Archivos

- `apuntes.md` — notas completas del curso con frameworks, SQL basico y errores comunes
- `actividad-bigquery/` — ejercicios de consultas SQL en BigQuery
- `actividad-roccc/` — practica de evaluacion de fuentes de datos con ROCCC
...
| Base de datos relacional | Una base de datos que contiene una series de tablas que pueden conectarse para formar relaciones |
...
| Consentimiento | El aspecto de la etica de datos que presume el derecho de un individuo a saber como y por que se usaran sus datos personales |
...
| Datos largos | Un conjunto de datos en el que cada fila es un punto de tiempo por sujeto |
...
| Datos amplios | Un conjunto de datos en el que cada sujeto tiene una sola fila con multiples columnas |
...
| Metadatos descriptivos | Metadatos que describen un dato y pueden usarse para identificarlo en un punto posterior |
| Metadatos estructurales | Metadatos que indican como se organiza un dato y si forma parte de una o mas colecciones |
...
| Pixel | En imagenes digitales, una pequena area de iluminacion en una pantalla que forma una imagen digital |
...
| Record | Una coleccion de datos relacionados en una tabla de datos, generalmente sinonimo de fila |
...
| Redes sociales | Sitios web y aplicaciones a traves de los cuales los usuarios crean y comparten contenido |
...
| Sesgo de datos | Cuando una preferencia sesga sistematicamente los resultados del analisis de datos en una cierta direccion |
| Sesgo de interpretacion | La tendencia a interpretar situaciones ambiguas de forma positiva o negativa |
| Sesgo de muestreo | Sobrerrepresentar o subrepresentar ciertos miembros de una poblacion |
...
| Transparencia de transacciones | El aspecto de la etica de datos que presume que todas las actividades de procesamiento de datos deben ser explicables |
